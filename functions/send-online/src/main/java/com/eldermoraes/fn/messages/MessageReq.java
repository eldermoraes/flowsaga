...
public class MessageReq implements Serializable {
    ...
    public static void sendSuccessMessage(SendOnlineRes debitRes, SendOnlineRes atmRes) {
        Flows.currentFlow().invokeFunction(funcMessage, composeSuccessMessage(debitRes, atmRes));
    }

    public static MessageReq composeSuccessMessage(SendOnlineRes debitResponse,
                                               SendOnlineRes atmResponse) {
        MessageReq result = new MessageReq();
        result.message = "Transaction confirmation: " + debitResponse.confirmation + "\n" +
                "Banking confirmation: " +  atmResponse.confirmation ;
        return result;
    }
    ...
    public static MessageReq composeFailMessage() {
        MessageReq result = new MessageReq();
        result.message = "We failed to perform your transaction, sorry.";
        return result;
    }
